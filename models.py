...
class CNN_Trial:
    ...
    def convblock(self, x, it):
        ...
        return x, self.params["n_filters"][it] * self.params["kernel_dims"][it][0] * self.params["kernel_dims"][it][1] * self.params["q_kernel_conv_bits"]
...
class Binary_Trial:
    ...
    def get_trial(self, trial):
        n_filters = [] # Not currently working
    ...
    def convblock(self, x, it):
        ...
        x = BatchNormalization()(x) # Should be folded into QuantConv2D after training
        
        if self.params["shortcut"]:
            x = Add(momentum=0.9)([x, cut]) 
